...
if (isset($_SESSION['message'])) {
    echo '<p style="color: #ea22ff; font-weight: 500;">' . $_SESSION['message'] . '</p>';
    unset($_SESSION['message']);
}

if (isset($_GET['timeout']) && $_GET['timeout'] === 'true') {
    echo "<script>alert('You were logged out due to inactivity.');</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <style>
    ...
    * {
    ...
    .logo img {
      width: 70px;
      height: 32px;
      filter: invert(50%) sepia(70%) saturate(600%) hue-rotate(230deg) brightness(90%);
    }
    nav.desktop-nav {
      display: flex;
      gap: 32px;
...
<body>
  <header>
    <div class="header-container">
      <div class="logo">
        <img src="images/logo.png" alt="Zentone Logo" />
        Zentone
      </div>
  ...
  <main>
    <section class="form-wrapper" aria-label="Login form">
      <h1>Log In</h1>
      <form action="db.php" method="POST" id="loginForm" novalidate>
        <div>
        ...
        <div>
          ...
          <div class="password-wrapper">
            ...
            />
            <span class="material-icons" tabindex="0" role="button" aria-label="Toggle password visibility" id="toggleLoginPassword">visibility_off</span>
          </div>
        </div>
  ...
  <script>
    ...
    togglePassword.addEventListener('click', () => {
      ...
      togglePassword.textContent = isVisible ? 'visibility_off' : 'visibility';
    });
